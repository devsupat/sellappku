...
export default async function ProductDetailPage({ params }: PageProps) {
 ...
 className="w-full flex items-center justify-center space-x-3 p-4 bg-white rounded-2xl shadow-sm hover transition-shadow mb-6"
 >
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="w-full flex items-center justify-center space-x-2 p-4 bg-white rounded-2xl shadow-sm hover transition-shadow"
 >
 ...
 {/* CTA Buttons */}
 <div className="flex flex-col sm gap-4 mb-8">
 <a
 href={whatsappLink}
 target="_blank"
 rel="noopener noreferrer"
 ...
 <div className="grid md lg gap-6">
