                        ...
                        {loading ? (
                            ...
                            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                                {filteredProducts.map((product) => (
                                    ...
                                    >
                                        {/* Thumbnail */}
                                        <div className="relative aspect-video bg-gradient-to-br from-violet-100 to-indigo-100 dark:from-violet-900/30 dark:to-indigo-900/30">
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                <Code2 className="h-16 w-16 text-violet-300 dark:text-violet-700" />
                                            </div>
                                            {product.is_featured && (
