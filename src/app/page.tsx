        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              Jual Beli <span className="text-indigo-600 dark:text-indigo-400">Source Code</span> & Aplikasi
              <br />Tanpa Ribet
            </h1>
            ...
            {featuredProducts.slice(0, 4).map((product: Product) => (
              ...
              >
                ...
                <div className="aspect-video bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 flex items-center justify-center">
                  <Code2 className="h-12 w-12 text-indigo-200 dark:text-indigo-800" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {featuredApps.slice(0, 3).map((app: App) => (
              ...
              >
                {/* Thumbnail */}
                <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-indigo-100 to-violet-100 dark:from-indigo-900/30 dark:to-violet-900/30 rounded-xl flex items-center justify-center">
                  <Smartphone className="h-8 w-8 text-indigo-300 dark:text-indigo-700" />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {app.has_tester && (
                      <span className="text-xs font-medium px-2 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded">
                        Tester
                      </span>
                    )}
                  </div>
