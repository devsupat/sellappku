...
export default function AboutPage() {
 ...
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-violet-400/20 to-indigo-400/20 rounded-full blur-3xl"></div>

 <div className="relative max-w-4xl mx-auto px-4 sm lg py-24 lg text-center">
 {/* Avatar */}
 <div className="mb-8">
 ...
 <Code2 className="h-16 w-16 text-violet-500" />
 </div>
 </div>
 </div>

 <h1 className="text-4xl lg font-bold text-gray-900 mb-4">
 ...
 <a
 href="#"
 className="p-3 rounded-xl bg-gray-100 hover transition-colors"
 >
 ...
 <div className="text-3xl lg font-bold gradient-text mb-1">
 {stat.value}
 </div>
 ...
 <div className="max-w-4xl mx-auto px-4 sm lg">
 ...
 Dari situlah <span className="font-semibold text-violet-600 ">Sellappku</span> lahir —
 ...
 <h2 className="text-3xl lg font-bold mb-4">
 Mari Bekerja Sama
 </h2>
 ...
 className="btn bg-white text-violet-600 hover"
 >
 ...
 <Link
 href="/products"
 className="btn bg-white/10 text-white hover border border-white/20"
 >
 Lihat Produk
