        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        {/* Thumbnail */}
                        <div className="aspect-video bg-gradient-to-br from-violet-100 to-indigo-100 dark:from-violet-900/30 dark:to-indigo-900/30 rounded-3xl flex items-center justify-center mb-6 shadow-lg">
                            <Code2 className="h-24 w-24 text-violet-300 dark:text-violet-700" />
                        </div>
                        ...
                        {product.video_url && (
                            <a
                                ...
                                className="w-full flex items-center justify-center space-x-3 p-4 bg-white dark:bg-gray-900 rounded-2xl shadow-sm hover:shadow-md transition-shadow mb-6"
                            >
                        ...
                        {product.demo_url && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full flex items-center justify-center space-x-2 p-4 bg-white dark:bg-gray-900 rounded-2xl shadow-sm hover:shadow-md transition-shadow"
                            >
                    ...
                    <div className="mt-16">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {product.features.map((feature, i) => (
                                ...
                                >
                                    <div className="inline-flex p-3 bg-violet-100 dark:bg-violet-900/30 rounded-xl mb-4">
                ...
                {/* Description */}
                {product.description && (
                    <div className="mt-16 bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-sm">
