...
export default function WebsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            {/* Pricing Info Banner */}
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 py-6 border-b border-emerald-200 dark:border-emerald-800">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                <p className="text-sm text-gray-500 dark:text-gray-400">Beli Source Code</p>
                                <p className="font-semibold text-gray-900 dark:text-white">Full akses, modif sesuka hati</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                <p className="text-sm text-gray-500 dark:text-gray-400">Pakai Langsung</p>
                                <p className="font-semibold text-gray-900 dark:text-white">1 lisensi = 1 device, lifetime</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {loading ? (
                    <div className="flex items-center justify-center py-16">
                        ...
                        <span className="ml-3 text-gray-600 dark:text-gray-400">Memuat layanan...</span>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredWebs.map((web) => (
                            ...
                            >
                                {/* Thumbnail */}
                                <div className="relative aspect-video bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30">
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <Globe className="h-16 w-16 text-emerald-300 dark:text-emerald-700" />
                                    </div>
                                    {web.is_featured && (
                    ...
                    <div className="text-center py-16">
                        <Globe className="h-16 w-16 text-gray-300 dark:text-gray-700 mx-auto mb-4" />
