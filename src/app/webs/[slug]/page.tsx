        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        {/* Thumbnail */}
                        <div className="aspect-video bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-3xl flex items-center justify-center mb-6 shadow-lg">
                            <Globe className="h-24 w-24 text-emerald-300 dark:text-emerald-700" />
                        </div>
                        ...
                        {web.demo_url && (
                            <a
                                ...
                                className="w-full flex items-center justify-center space-x-2 p-4 bg-white dark:bg-gray-900 rounded-2xl shadow-sm hover:shadow-md transition-shadow mb-6"
                            >
                    ...
                    <div>
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <div className="bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-violet-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border-2 border-violet-200 dark:border-violet-800">
                ...
                {/* Description */}
                {web.description && (
                    <div className="mt-12 bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-sm">
