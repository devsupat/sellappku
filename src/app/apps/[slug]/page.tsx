        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        {/* Thumbnail */}
                        <div className="aspect-video bg-gradient-to-br from-indigo-100 to-violet-100 dark:from-indigo-900/30 dark:to-violet-900/30 rounded-3xl flex items-center justify-center mb-6 shadow-lg">
                            <Smartphone className="h-24 w-24 text-indigo-300 dark:text-indigo-700" />
                        </div>
